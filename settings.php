...
post("mapY","integer");
post("mapR","integer");
if (isset($POST['mapX']) and isset($POST['mapY']) and isset($POST['mapR']))
{
    account_set_map_defaults($sql, $_SESSION['AID'], $POST['mapX'], $POST['mapY'], $POST['mapR']);
    $_SESSION['DefMapX']=$POST['mapX'];
    $_SESSION['DefMapY']=$POST['mapY'];
    $_SESSION['DefMapR']=$POST['mapR'];
}
...
$T->Insert(3,$u,new Br());
$T->Insert(3,$u,new Link("settings.php?thm=sharp","sharp"));
...
$H->Insert(new Link("sit.php","Account Sitting management"));
