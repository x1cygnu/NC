...
$H->Insert("(all links will open in new window)");
$T=new Table();
$T->sClass='block';
...
$T->Insert(3,5,"TODO: FRAMES 248-350 INCLUDING WATER ARE RE-RENDERED");
$T->Insert(3,5,new Link("desc_water.png","Frame 317 - wavy water","_blank"));
$T->Insert(3,5,new Br());
$T->Insert(3,5,new Link("desc_water_bright.png","Frame X with increased brightness","_blank"));
$T->Insert(3,5,new Br());
...
$T->Insert(3,7,"Because there is only one object with high number of triangles - namely the candle fire - the difference between primitive and volume heristics is minimal.<br>
