...
$T->Insert(2,$row,MakeHint($Tech['Name'],$Tech['Hint']));
...
{
    if ($comma) $T->Insert(5,$row,",");
    if ($Tech['Error'][7]) $T->Insert(5,$row,"<b>" . $Techs[$Tech['Tech1']]['Help'] . "</b>");
    else $T->Insert(5,$row,"" . $Techs[$Tech['Tech1']]['Help']);
    $comma=true;
}
if ($Tech['Tech2']>0)
{
    if ($comma) $T->Insert(5,$row,",");
    if ($Tech['Error'][8]) $T->Insert(5,$row,"<b>" . $Techs[$Tech['Tech2']]['Help'] . "</b>");
    else $T->Insert(5,$row,"" . $Techs[$Tech['Tech2']]['Help']);
    $comma=true;
}
